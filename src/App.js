...
var mockVideoSequenceData = [
  {
    first : true,
    videoData : [{source : "./Video/EarthSlowNosun",
                  caption : [
                    {type : "headline",
...
var VideoContent = React.createClass({
  render: function(){
    ...
    return (
      ...
      <source src={this.props.source + ".mp4"} type="video/mp4"></source>
      <source src={this.props.source + ".webm"} type="video/webm"></source>
      </video>
    )
...
var CaptionRight = React.createClass({
  render : function(){
    ...
    return <div className="video-caption video-caption--right"> "Right" </div>
...
var CaptionLeft = React.createClass({
  render : function(){
    ...
    return <div className="video-caption"> "Left" </div>
...
var CaptionCenter = React.createClass({
  render : function(){
    ...
    return <div className="video-caption video-caption--center"> "Center" </div>
...
var CaptionLong = React.createClass({
  render : function(){
    ...
    return <div className="video-caption video-caption--long"> "Long" </div>
  ...
  render: function(){
    ...
    var Video = React.createClass({
      ...
      fixedScroll : function(){
        ...
        if(this.props.first || this.props.last){
          ...
          var fixed = (this.props.first && this.state.rect.top < fixTop)
          || (this.props.last && this.state.rect.bottom >= fixTop + fixHeight);
    ...
    var VideoSequence = React.createClass({
      ...
      render: function(){
        ...
        var videoSequence = this.props.sequenceData.videoData.map(
        ...
        return(
          <div className="section video-sequence" style ={{background : this.state.background}} onScroll={this.handleScroll} onResize={this.handleResize}>
          {videoSequence}
          </div>
        )
      }
    ...
    var Article = React.createClass({
      ...
      render : function() {
        var allSequences = this.props.data.map(
          function(sequence,index,total){
